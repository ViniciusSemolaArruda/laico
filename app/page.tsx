...
export default async function HomePage({
  ...
  /*
   * Ignoramos categorias que não existem.
   */
   ...
   * =====================================================
   *
   * Produtos inativos ou arquivados nunca aparecem.
   */
   ...
   * RELIGIÕES
   *
   * Consultamos o novo campo religions e
   * também o campo antigo religion.
   */
   ...
   * =====================================================
   *
   * Selecionamos apenas dados públicos.
   *
   * Custo e informações administrativas não são carregados.
   */
