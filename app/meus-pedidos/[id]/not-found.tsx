    ...
    <>
      ...
      <main className="flex min-h-[70vh] items-center justify-center bg-[#faf9f6] px-5 py-16">
        <section className="w-full max-w-[620px] rounded-3xl border border-red-200 bg-white p-8 text-center shadow-sm md:p-12">
          ...
          <div className="mt-8 rounded-2xl border border-[#e8dcc2] bg-[#faf9f6] p-4 text-sm leading-relaxed text-neutral-600">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link
              href="/"
              className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#b98218] px-6 font-extrabold text-white shadow-lg transition hover:bg-[#9f6f14] sm:w-auto"
            >
              <Home
                size={18}
                aria-hidden="true"
            ...
            <Link
              href="/checkout"
              className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl border border-[#e8dcc2] bg-white px-6 font-extrabold text-[#20170f] transition hover:bg-[#faf9f6] sm:w-auto"
            >
              <ArrowLeft
                size={18}
                aria-hidden="true"
          ...
          <p className="mt-7 text-xs leading-relaxed text-neutral-400">
            Se você realizou esta compra, abra
            o pedido utilizando o mesmo
            navegador e dispositivo usados no
            checkout.
          </p>
        </section>
      </main>
